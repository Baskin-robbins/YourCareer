...
<body>
    <div class="wrapper">
        <nav>
            <div class="logo">
                <a href="/"><img src="${path}/resources/img/br.png" alt="Logo" class="logo-img"></a>
            </div>
            <div class="content">
                <ul>
        ...
        <div class="bkbg">
            <div class="gallery">
                <div class="grid-container">
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b1.png" alt="bk" class="bk"></a><br>
                        <a>책 내용을 압축한 최종 프로젝트로코딩 실력을 한 단계 더 높여 보세요!</a>
                    </div>
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b2.png" alt="Logo" class="bk"></a><br>
                        <a>기본기를 꼼꼼하게! 실전에서 효과적으로 활용하는 방법까지 알차게 배우자</a>
                    </div>
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b3.png" alt="Logo" class="logo-img"></a><br>
                        <a>깃허브를 통해 이력서나 포트폴리오를 만들어 취업에 성공하고 싶은 분</a>
                    </div>
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b1.png" alt="Logo" class="logo-img"></a><br>
                        <a>책 내용을 압축한 최종 프로젝트로코딩 실력을 한 단계 더 높여 보세요!</a>
                    </div>
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b2.png" alt="Logo" class="logo-img"></a><br>
                        <a>책 내용을 압축한 최종 프로젝트로코딩 실력을 한 단계 더 높여 보세요!</a>
                    </div>
                    <div class="grid-item">
                        <a href="/"><img src="${path}/resources/img/b3.png" alt="Logo" class="logo-img"></a><br>
        ...
        <div class="gallery3">
            <div class="grid-container3">
                <div class="grid-item3">
                    <img src="${path}/resources/img/qna.png" alt="">
                    <button id="qna">
                        <p>아직도 궁금한게 있다면?</p>
                        <p>QnA 바로가기</p>
                    </button>
                ...
                <div class="grid-item3">
                    <img src="${path}/resources/img/job.jpg" alt="">
                    <button id="job">
                        <p></p>
                        <p>취업 정보 보러가기</p>
                    </button>
